...
=======================================================
Kết hợp WebSocket để nhận tick real-time, tự aggregate thành nến,
...
Luồng:
  ...
  7. Ping/pong thread gửi keepalive định kỳ để giữ kết nối WebSocket
"""
...
from ssi_sdk import Auth, Data, Stream, Trading
